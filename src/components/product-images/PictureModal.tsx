    ...
    return (
        <div className="absolute flex flex-col top-[27.5%] left-[50%] translate-x-[-50%] translate-y-[-50%] mx-auto">
            ...
            <div className="flex absolute mt-[17.5rem]">
                ...
                <div className="flex ml-[27.35rem] translate-x-[1.75rem] place-items-center h-[56px] w-[56px] border-0 bg-white rounded-full cursor-pointer" onClick={() => handleSwitchImgNext()}>
