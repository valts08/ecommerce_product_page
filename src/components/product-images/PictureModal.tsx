...
const PictureModal = () => {
    ...
    const handleSwitchImgPrevious = () => {
        console.log(images.mainImageId % images.mainImages.length)
        dispatch(prevImage())
    }
    ...
    return (
        <div className="absolute flex flex-col">
            <img className="h-[20px] w-[20px] pb-3 cursor-pointer" src={CloseModalIcon} alt="close-modal" onClick={() => handleModalClose()}/>
            <img className="h-[550px] w-[550px] border-0 rounded-lg" src={images.mainImages.at(images.mainImageId % images.mainImages.length)} alt="modal-image"/>
            <div className="flex place-items-center h-[56px] w-[56px] border-1 bg-white rounded-full cursor-pointer" onClick={() => handleSwitchImgNext()}>
                <img className="h-[16px] w-[12px] m-auto" src={NextImgIcon} alt="next-img-icon"/>
            </div>
            <div className="flex place-items-center h-[56px] w-[56px] border-1 bg-white rounded-full  cursor-pointer" onClick={() => handleSwitchImgPrevious()}>
